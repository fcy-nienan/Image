...
public class DataSourceFactory implements ObjectFactory {
    ...
    private encrypt encrypt=new encryptPassword();
    ...
    public Object getObjectInstance(Object obj, Name name, Context nameCtx,
        ...
        for (int i = 0 ; i < ALL_PROPERTIES.length ; i++) {
            ...
            if (ra != null) {
                ...
                if (propertyName.equals(PROP_PASSWORD)){
                    System.out.println("password:"+propertyValue);
                    propertyValue=encrypt.decryptPassword(propertyValue);
                }
